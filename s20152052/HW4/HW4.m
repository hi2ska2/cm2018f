...
V_g=[0:0.1:1]'; % set: fermi level= 0 V at equilibrium 

for j=1:11;
    b_cont=((WF-V_g(j,1))-IF); % using elecmentary charge unit
A=zeros(N,N);
A(1,1)=1.0;
for ii=2:N-1
...
plot(V_g,diff_potential(31,:)) % difference b/w 1st and 2nd potential at 3 nm
