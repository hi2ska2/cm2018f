...
plot 'EDlong_61_init.dat' u ($1*l1):($2+0.001) title '\small P',\
'ED_long_61_after.dat' u ($1*l1):($2+0.001) title '\small C'
...
plot 'EDshort_25_init.dat' u ($1*l2):($2+0.001) title '\small P',\
'ED_short_25_after.dat' u ($1*l2):($2+0.001) title '\small C'
