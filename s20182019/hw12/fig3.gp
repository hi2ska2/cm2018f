...
plot 'EDlong_1201_init.dat' u ($1*l1):($2+0.001) title '\small P',\
'ED_long_1201_after.dat' u ($1*l1):($2+0.001) title '\small C'
...
plot 'EDshort_601_init.dat' u ($1*l2):($2+0.001) title '\small P',\
'ED_short_601_after.dat' u ($1*l2):($2+0.001) title '\small C'
