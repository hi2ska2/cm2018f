...
subplot_n.semilogy(x_grid*1e+9,n_electron_nlPoisson,label ='Poisson')
...
subplot_err.plot(x_grid*1e+9, 100*(n_electron_nlPoisson-n_electron)/n_electron_nlPoisson)
subplot_err.set_xlabel("position (nm)",fontsize=11)
...
plt.suptitle("Poisson-Continuity :"+structure+"/"+str(spacing),fontsize=20)
plt.savefig("./result_"+structure+"_"+str(spacing)+".png")
plt.show()
